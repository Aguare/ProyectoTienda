 ...
 * @author aguare
 */
public class PedidosAtrasados extends javax.swing.JFrame {
    ...
    private void comboTiendasItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboTiendasItemStateChanged
        ...
        if (n >= 0) {
            datos = reportes.PedidosAtrasados(listaTiendas.get(comboTiendas.getSelectedIndex()).getCodTienda());
            agregarLista();
        }
