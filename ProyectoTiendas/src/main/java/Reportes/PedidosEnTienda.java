 ...
 * @author aguare
 */
public class PedidosEnTienda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PEDIDOS EN TIENDA SIN RECOGER");
    ...
    private void comboTiendasItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboTiendasItemStateChanged
        ...
        if (n >= 0) {
            datos = reportes.PedidosEnTienda(listaTiendas.get(comboTiendas.getSelectedIndex()).getCodTienda());
            agregarLista();
        }
