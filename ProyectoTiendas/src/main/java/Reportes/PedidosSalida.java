 ...
 * @author aguare
 */
public class PedidosSalida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PEDIDOS ENVIADOS POR TIENDA QUE ESTÁN EN TRÁNSITO");
    ...
    private void comboTiendasItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboTiendasItemStateChanged
        ...
        if (n >= 0) {
            datos = reportes.PedidosSalidaTransito(listaTiendas.get(comboTiendas.getSelectedIndex()).getCodTienda());
            agregarLista();
        }
