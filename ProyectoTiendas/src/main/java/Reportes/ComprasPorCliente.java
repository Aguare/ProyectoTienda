 ...
 * @author aguare
 */
public class ComprasPorCliente extends javax.swing.JFrame {
    ...
    private void ingresarClientes() {
        for (Cliente l : listaClientes) {
            comboTiendas.addItem("" + l.getNIT() + ",\t" + l.getNombre());
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("COMPRAS REALIZADAS POR EL CLIENTE");
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Venta", "Fecha", "Total Venta", "Tienda", "Empleado", "No. Lista de Productos"
            }
        ) {
    ...
    private void comboTiendasItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboTiendasItemStateChanged
        ...
        if (n >= 0) {
            datos = reportes.ComprasSegunCliente(listaClientes.get(comboTiendas.getSelectedIndex()).getNIT());
            agregarLista();
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (numero > 0) {
            String valor = (String) modelo.getValueAt(numero, 5);
